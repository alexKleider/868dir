...
"""
    Displays the schema of our data base.
    Serves as an "Entity Relationship Diagram."
    (Derived from the sql_code.py module.)
...
try: from code import sql_code
except ImportError: import sql_code
...
def get_schema():
    """
    Gets the schema from our data base.
    ...
    query = """
            ...
            ;
            """
    for (tableName, ) in sql_code.fetch(query, from_file=False):
        ret.append('')
        ...
        ) in sql_code.fetch("pragma table_info('{}');"
